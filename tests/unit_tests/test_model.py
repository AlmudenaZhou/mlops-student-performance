...
def test_base64_decode():
    ...
    expected_result = {
        "student": 
            {"StudentID": 2566.0, "Age": 17.0, "Gender": 0.0, "Ethnicity": 0.0, "ParentalEducation": 0.5,
            "StudyTimeWeekly": 0.41918744404386094, "Absences": 0.3103448275862069, "Tutoring": 0.0,
            "ParentalSupport": 0.75, "Extracurricular": 0.0, "Sports": 0.0, "Music": 0.0, "Volunteering": 0.0}, 
        "student_id": 2566.0
        }
...
def test_preprocessing():
    ...
    expected_features = {'ParentalEducation': {0: 0.5}, 'StudyTimeWeekly': {0: 0.5}, 'Absences': {0: 0.5}, 
                         'Tutoring': {0: 0.0}, 'ParentalSupport': {0: 0.5}, 'Extracurricular': {0: 0.0}, 
                         'Sports': {0: 0.0}, 'Music': {0: 0.0}, 'Volunteering': {0: 0.0}}
